-- Fix artist/sale tax totals: legacy backfill stores tax on sales.tax_total only
-- (line items have tax_amount = 0). Use the sale header when line tax is missing.
